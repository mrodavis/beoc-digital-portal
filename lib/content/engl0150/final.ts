...
export const finalAssessment = {
  ...
  quizItems: [
    ...
    },
    {
      ...
      choices: [
        { text: "Fewer appointments were cancelled and there was less paperwork.", correct: true, rationale: "Correct. Appointments are counted; paperwork is measured." },
        { text: "Less appointments were cancelled and there was fewer paperwork.", correct: false, rationale: "Both are reversed." },
        { text: "Less appointments were cancelled and there was less paperwork.", correct: false, rationale: "'Appointments' are countable and need 'fewer'." },
        { text: "Fewer appointments were cancelled and there was fewer paperwork.", correct: false, rationale: "'Paperwork' is measured and needs 'less'." },
      ],
    },
  ] as DrillItem[],
};
